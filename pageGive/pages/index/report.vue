<template>
	<view class="report">
		<view class="reportH">
			...
			<view :class="['reportHB',item.state?'reportActive':'']" v-for="(item,index) in reasonList" :key="index" :data-index="index" @click="getActive">
		...
		<view class="reportB">
			...
			<view class="reportBB">
				<textarea name="" @input="getlength" placeholder="请描述举报内容" v-model="desc" id="" maxlength="100" disable-default-padding="true" cols="30" rows="10"></textarea>
			</view>
		</view>
