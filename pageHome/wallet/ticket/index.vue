...
<script>
  ...
  export default {
    ...
    methods: {
		toGetList(){
			this.$navTo("pageHome/distribution/withdrawal/index",{type:3})
		},
      // 获取页面数据
      getPageData() {
        const app = this
      ...
      onTargetCashier() {
        this.$navTo('pageHome/cashier/withdrawal?type=10')
      },
      onTargetRechargeOrder() {
        this.$navTo('pageHome/wallet/refund/details',{type:2})
      },
      onTargetBalanceLog() {
