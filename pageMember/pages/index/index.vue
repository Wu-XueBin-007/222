		...
		<view class="advertisementR">
			...
			<view class="advertisementRB">
				...
				<view class="advertisementRBR">
					{{bigUser.now_reward}}//{{setting.threshold_money}}
				</view>
			</view>
		</view>
	</view> -->
...
<script>
  ...
  export default {
    ...
    methods: {
		...
		getDetail(){
			let obj ={};
			obj.group_order_id = this.group_order_id;
			LuxuryApi.detail(obj).then(res=>{
				console.log(res,123)
  ...
  //       this.$navTo('pages/goods/detail', { goodsId,bigId,group_order_id })
    ...
    onShareAppMessage() {
      // 构建分享参数
	  console.log(this.group_order_id,123456111)
      return {
        title: "大会员专区",
        path: "/pageMember/pages/index/index?" + this.$getShareUrlParams()
      }
    },
