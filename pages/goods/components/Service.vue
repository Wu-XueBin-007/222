  ...
  <view v-if="list.length" class="service-wrapper">
    ...
    <view class="service-simple" @click="handlePopup">
		<view class="service-title">
			服务
			<!-- <image src="../../../static/icon/icon_fuwu.png"mode=""></image> -->
		</view>
      <view class="s-list">
        <view class="s-item" v-for="(item, index) in list" :key="index">
          <!-- <text class="item-icon iconfont icon-fuwu"></text> -->
		 <!-- <image src="../../../static/icon/icon_qi.png" v-if="index==0" mode=""></image>
		  <image src="../../../static/icon/icon_zp.png" v-else-if="index==1" mode=""></image> -->
