      ...
      <u-form :model="form" ref="uForm" label-width="140rpx">
        ...
        <u-form-item label="证件类型" prop="certificates_type">
			<view style="position: relative;">
				<picker mode="selector" @change="certificatesPickerChange" :range="certificatesList" range-key="name">
		...
		<!-- <u-form-item label="12306账号" prop="train_account_number">
		  <u-input v-model="form.train_account_number" @blur="toMond"/>
		</u-form-item>
		<u-form-item label="12306密码" prop="train_password">
		  <u-input v-model="form.train_password"/>
		</u-form-item>
		<u-form-item label="旅客类型" prop="passenger_discount_type">
			<view style="position: relative;">
				<picker mode="selector" @change="passengerPickerChange" :range="passengerList" range-key="name">
